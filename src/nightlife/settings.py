...
INSTALLED_APPS = [
    'accounts', # Mis en premier pour qu'il override la gestion des utilisateurs de base de Django
...
#Changer redirection url apres connexion/deco
LOGIN_REDIRECT_URL = "events:list"
LOGOUT_REDIRECT_URL = "home"

#Générer le mail par console
