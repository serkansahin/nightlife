...
from artists.views import ArtistsList, ArtistCreate, ArtistCreateSpotifyFollowings, ArtistFollowSpotifyFollowings, ArtistDelete, ArtistDetail, ArtistCommentView, ArtistUpdate, ArtistFollowingView
...
urlpatterns = [
    ...
    path('<str:slug>/comment', ArtistCommentView, name='comment'),
